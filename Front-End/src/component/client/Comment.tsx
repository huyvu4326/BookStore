          ...
          <div className="product-customer-box">
            ...
            <div className="product-customer-content">
              ...
              <div className="product-customer-col-3">
                ...
                <button
                  className="btn btn-default js-customer-button"
                  type="button"
                  id="showconment_click"
                >
                  Đóng
                </button>
              </div>
              ...
              <div
                className="product-customer-col-4 js-customer-col-4 "
                style={{ display: "block" }}
                id="conment_2"
              >
                <div className="customer-col-5">
                  ...
                  <div id="rating_wrapper" className="text_bt rate">
                    ...
                    >
                      <img
                        src="./src/assets/client-images/star-off.png"
                        alt="1"
                        title="bad"
                      />
                      &nbsp;
                  ...
                  <div className="action">
                    <div className="word-counter" style={{ opacity: "0" }}>
                      Bạn cần viết đủ <strong>100</strong> từ để gửi nhận xét
                      hợp lệ.
                    </div>
                    ...
                    <button
                      className="btn btn-default btn-add-review "
                      type="button"
                    >
                      Gửi nhận xét
                    </button>
